class Document(object):
    ...
    def __init__(self, title='', desc='', text='', date=None, raw_data=None):
        ...
        self._annotations = {'what': [], 'who': [], 'why': [], 'where': [], 'when': [], 'how': [], 'money': []}
    ...
    def get_money_answer(self):
        return self._money_answer

    def set_money_answer(self, money_answer):
        self._money_answer = money_answer

    def get_location_answer(self):
        return self._location_answer

    def set_location_answer(self, location_answer):
        self._location_answer = location_answer
